...
module.exports = {
  ...
  <div>
    ...
    <section class="section">
      ...
      <div>
        <input class='input-text native-key-bindings' type='text' placeholder='Project Path' id='vipera-tools-mam-newprj-folder-textfield'>
      </div>
      ...
      <div class='block'>
        <div class='btn-group'>
          ...
          <button class='inline-block btn highlight' id='vipera-tools-mam-newprj-choosefolder'>Choose Folder...</button>
        </div>
      </div>
