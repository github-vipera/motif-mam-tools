  ...
  <div style='margin:30px;'>
        ...
        <section class="section">
          <div class="section-container" style="display:flex;">
            <div class="section-heading" style="font-size: 1.75em;font-weight: bold;line-height: 1;-webkit-user-select: none;cursor: default;width:80%;">
              <span class="icon icon-puzzle">MOTIF API Modeler Workbench</span>
            </div>
            <div>
              <label style="vertical-align: middle;padding-top:2px;" class='input-label'><input class='input-toggle' type='checkbox' unchecked>Enable Mock</label>
            </div>
          </div>
        </section>
